        ...
        <div class="container">
            ...
            <div class="search-box">
                ...
                <div style="text-align: center; margin-top: 15px;">
                    <asp:Button ID="btnSearch" runat="server" Text="Search Product" CssClass="btn btn-search" OnClick="btnSearch_Click" />
            ...
            <div class="result-box">
                ...
                <asp:Label ID="lblResultCount" runat="server" Text="Select a product from the dropdown to view details." CssClass="result-count" />
